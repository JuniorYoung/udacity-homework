...
var Engine = (function(global) {
    ...
    var doc = global.document,
        ...
        lastTime,
        requestId,
        cancelAnimationFrame = global.cancelAnimationFrame || global.mozCancelAnimationFrame;
    canvas.id = 'cloneGameCanvas';
    canvas.width = 505;
    canvas.height = 606;
    ...
    function render() {
        ...
        // if(player.isDead){
        //   //整个界面
        //   canvasGrayHandle(0, 0, canvas.width, canvas.height);
        //   //玩家
        //   //canvasGrayHandle(player.x, player.y, EACH_COLWIDTH, EACH_ROWHEIGHT);
        // }
        //渲染游戏界面各种道具
        //星星
        ctx.drawImage(Resources.get('images/Star.png'), STAR_X, STAR_Y);
        //岩石
        ctx.drawImage(Resources.get('images/Rock.png'), ROCK_X, ROCK_Y);
        renderEntities();
    }
    //界面灰色处理
    function canvasGrayHandle(x,y,width,height) {
     ...
     */
    global.ctx = ctx;
    global.initGameModel = initGameModel;
    global.engineMain = main;
})(this);
